...
function Movies() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <h1 className="text-3xl font-bold text-center mb-8  text-black-400 text-shadow-black-600 animate-pulse">
        Popular Movies
      </h1>
      ...
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-4 mb-8 px-4 ">
        <input
          ...
          className="w-full sm:flex-1 px-5 py-3 rounded-xl shadow-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
        />
        <select
          value={minRating}
          onChange={(e) => setMinRating(e.target.value)}
          className="w-full sm:w-48 px-5 py-3 rounded-xl shadow-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition"
        >
